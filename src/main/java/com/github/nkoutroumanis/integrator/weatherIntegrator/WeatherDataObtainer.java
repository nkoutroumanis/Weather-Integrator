...
//        private final DateFormat dateFormat;
        ...
        public Builder(String gribFilesFolderPath, List<String> variables) {
...
//        }
        ...
        public WeatherDataObtainer build() {
            return new WeatherDataObtainer(this);
        }

    }

    private WeatherDataObtainer(Builder builder) {
...
//        dateFormat = builder.dateFormat;
        ...
        lruCacheManager = LRUCacheManager.newLRUCacheManager(GribFilesTree.newGribFilesTree(gribFilesFolderPath, gribFilesExtension),
                LRUCache.newLRUCache(lruCacheMaxEntries), useIndex, builder.variables);
    }
    ...
    public static Builder newWeatherDataObtainer(String gribFilesFolderPath, List<String> variables) {
        return new WeatherDataObtainer.Builder(gribFilesFolderPath, variables);
    }
