...
public final class CheckSpatialDataInsideBox implements FilesParse {
    ...
    public static class Builder {
        ...
        public Builder(Parser parser, int numberOfColumnLongitude, int numberOfColumnLatitude, Rectangle rectangle) {
...
//        }
    ...
    public static Builder newCheckSpatioTemporalInfo(Parser parser, int numberOfColumnLongitude, int numberOfColumnLatitude, Rectangle rectangle) {
