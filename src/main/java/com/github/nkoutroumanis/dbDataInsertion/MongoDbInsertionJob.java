...
//        System.out.println((System.currentTimeMillis()-t)/1000);
        ...
        MongoDbDataInsertion.newMongoDbDataInsertion(connector1, FileDatasource.newFileParser("/home/nikolaos/Documents/thesis-dataset/", ".csv"), 2, 3, 4, "yyyy-MM-dd HH:mm:ss").build().insertDataOnCollection("geoPoints");
        ...
        MongoDbDataInsertion.newMongoDbDataInsertion(connector2, FileDatasource.newFileParser("/home/nikolaos/Documents/synthetic-dataset1/", ".csv"), 2, 3, 4, "yyyy-MM-dd HH:mm:ss").build().insertDataOnCollection("geoPoints");
        ...
        MongoDbDataInsertion.newMongoDbDataInsertion(connector3, FileDatasource.newFileParser("/home/nikolaos/Documents/synthetic-dataset2/", ".csv"), 2, 3, 4, "yyyy-MM-dd HH:mm:ss").build().insertDataOnCollection("geoPoints");
